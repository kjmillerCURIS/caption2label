...
#$ -l gpu_c=7.0
#$ -l h_rt=11:59:59
#$ -N eval_patch_alignment_with_multilabel_smart_start_clip_aug_embedder_only_simple_avg_prevalent_classes_only
#$ -j y
#$ -m ea
