...
def eval_clip_ensemble_baseline(dataset_parent_dir, experiment_dir, is_laclip=False):
    ...
    for dataset_name in dataset_names:
        ...
        results = evaluate_clip_ensemble_baseline(dataset_name, dataset_parent_dir, is_laclip=is_laclip)
...
def usage():
    print('Usage: python eval_clip_ensemble_baseline.py <dataset_parent_dir> <experiment_dir> [<is_laclip>=False]')


if __name__ == '__main__':
    eval_clip_ensemble_baseline(*(sys.argv[1:]))
