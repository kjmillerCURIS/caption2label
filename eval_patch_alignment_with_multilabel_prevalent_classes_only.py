...
def eval_patch_alignment_with_multilabel_prevalent_classes_only(dataset_parent_dir, experiment_dir, class_prevalence_dict_filename, is_laclip=False):
    ...
    for checkpoint_filename in checkpoint_filenames:
        ...
        for dataset_name in dataset_names:
            ...
            results = evaluate_patch_alignment_with_multilabel(dataset_name, dataset_parent_dir, checkpoint, p, class_prevalence_dict_filename=class_prevalence_dict_filename, is_laclip=is_laclip)
...
def usage():
    print('Usage: python eval_patch_alignment_with_multilabel_prevalent_classes_only.py <dataset_parent_dir> <experiment_dir> <class_prevalence_dict_filename> [<is_laclip>=False]')


if __name__ == '__main__':
    eval_patch_alignment_with_multilabel_prevalent_classes_only(*(sys.argv[1:]))
